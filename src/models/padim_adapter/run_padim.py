"""Thin adapter for invoking PaDiM scripts from section pipelines."""
...
def main() -> int:
    if len(sys.argv) < 2:
        print("usage: python -m src.models.padim_adapter.run_padim <script> [args...]")
        return 2
    repo_root = Path(__file__).resolve().parents[3]
    external_root = repo_root / "external" / "PaDiM-Anomaly-Detection-Localization-master"
